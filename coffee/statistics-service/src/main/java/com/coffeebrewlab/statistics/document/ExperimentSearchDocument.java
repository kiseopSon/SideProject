package com.coffeebrewlab.statistics.document;
...
@NoArgsConstructor
@AllArgsConstructor
public class ExperimentSearchDocument {
    ...
    @Field(type = FieldType.Date, format = {DateFormat.date_time, DateFormat.date_hour_minute_second, DateFormat.date_optional_time})
